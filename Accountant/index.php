				...
				<div class="col-md-3">
                        <div class="card bg-success text-white mb-3">
                            ...
                            <div class="card-footer d-flex align-items-center justify-content-between">
                                <a class="small text-white stretched-link" href="../Admin/members.php">View members</a>
...
{ 
   echo $row['total'];
                            ...
                            <div class="card-footer d-flex align-items-center justify-content-between">
                                <a class="small text-white stretched-link" href="index.php?page=loans">Contribution List</a>
                                <div class="small text-white">
                                	<i class="fas fa-angle-right"></i>
                                </div>
                            </div>
...
<div class="sec
"><h5 class="text-justify text-center"><u>Charts</u></h5>
    <div id="chart-container" >
        <canvas  id="graphCanvas"></canvas>
        <p class="text-center"><small>1.0<i> Contributions graph</i></small></p>
    </div>
                ...
                function (data)
                {
                    ...
                    var chartdata = {
                        ...
                        datasets: [
                            {
                                label: 'amount',
                                backgroundColor: '#49e2bb',
                                borderColor: '#46d5f1',
                                hoverBackgroundColor: '#496',
