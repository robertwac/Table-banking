            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        <h4 class="text-center">Released loans</h4>
                                           </div>
                    <form id="#data">
                    <?php
...
join loan_type on loan_type.type_id=loan_list.type_id  where loan_list.status = 3";
                    ...
                    if($result = mysqli_query($link, $sql)){
                        ...
                        $amount1 =number_format($amount1);
                                    echo "<tr>";
                                        ...
                                        echo "<td> <button class='btn btn-success' value='Released'>Released</button></td>";
